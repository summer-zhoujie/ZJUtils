...
public final class ZJReflectUtils {
    ...
    private ZJReflectUtils(final Class<?> type) {
        this(type, type);
    }

    private ZJReflectUtils(final Class<?> type, Object object) {
        this.type = type;
        this.object = object;
    }
     ...
     * @return the single {@link ZJReflectUtils} instance
     * @throws ReflectException if reflect unsuccessfully
     */
    public static ZJReflectUtils reflect(final String className)
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static ZJReflectUtils reflect(final String className, final ClassLoader classLoader)
            throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static ZJReflectUtils reflect(final Class<?> clazz)
            throws ReflectException {
        return new ZJReflectUtils(clazz);
    }
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static ZJReflectUtils reflect(final Object object)
            throws ReflectException {
        return new ZJReflectUtils(object == null ? Object.class : object.getClass(), object);
    }
     ...
     * @return the single {@link ZJReflectUtils} instance
     */
    public ZJReflectUtils newInstance() {
     ...
     * @return the single {@link ZJReflectUtils} instance
     */
    public ZJReflectUtils newInstance(Object... args) {
    ...
    private ZJReflectUtils newInstance(final Constructor<?> constructor, final Object... args) {
        try {
            return new ZJReflectUtils(
     ...
     * @return the single {@link ZJReflectUtils} instance
     */
    public ZJReflectUtils field(final String name) {
        try {
            Field field = getField(name);
            return new ZJReflectUtils(field.getType(), field.get(object));
     ...
     * @return the single {@link ZJReflectUtils} instance
     */
    public ZJReflectUtils field(String name, Object value) {
        try {
            Field field = getField(name);
    ...
    private Object unwrap(Object object) {
        if (object instanceof ZJReflectUtils) {
            return ((ZJReflectUtils) object).get();
        }
        return object;
    }
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public ZJReflectUtils method(final String name) throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public ZJReflectUtils method(final String name, final Object... args) throws ReflectException {
        Class<?>[] types = getArgsType(args);
        try {
    ...
    private ZJReflectUtils method(final Method method, final Object obj, final Object... args) {
        try {
            accessible(method);
    ...
    public boolean equals(Object obj) {
        return obj instanceof ZJReflectUtils && object.equals(((ZJReflectUtils) obj).get());
    }
